...
uint8_t mmc_disk_read (uint8_t * buff, uint32_t sector, unsigned int count);
uint8_t mmc_disk_write (const uint8_t* buff, uint32_t sector, unsigned int count);
uint8_t mmc_disk_ioctl (uint8_t cmd, void* buff);
